...
\usepackage{hyperref}
\hypersetup{
    colorlinks=true,       % enlaces con colores en lugar de cuadros
    linkcolor=blue,        % color de enlaces internos (índice, referencias)
...
\tableofcontents
\newpage
\section{Back sustitution \& forward sustitution}
\input{sustitution.tex}
\section{Matriz de Householder}
\input{matriz-householder.tex}
...
\input{m-potencias.tex}
\section{Singular Value Descomposition}
\subsection{Solución de sistemas con SVD}
\end{document}
